...
This is a Mule implementation of MUnit (Mule Testing Framework). It has 4 basic Mule flow example with the corresponding MUnit Test Suite. The implementation targets to use MUnit on the following basic connectors:
